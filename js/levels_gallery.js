...
var imgsMax = 40;  // total number of images
var slideTimeout = 7; // seconds before loading the next slide

var gPath = 'images/level_images/';  // gallery files (thumbnails) path, include trailing slash
var gPrefix = 'tnshell';
var gSuffix = '';
var gExt = '.jpg';
...
var sPath = 'images/level_images/'; // slideshow files (big imgs) path, include trailing slash
var sPrefix = 'shell';
var sSuffix = '';
var sExt = '.jpg';
...
for ( loopIndex=0;loopIndex<=imgsMax;loopIndex++)
  {
   numOfStars=(loopIndex%5+1);
   for (loopIndex2=0;loopIndex2<numOfStars;loopIndex2++)  
        starImg=starImg+'<img src="images/star.png" alt="Star height="20" width="20"">';
  captions[loopIndex] = starImg;
  starImg='';
  }
